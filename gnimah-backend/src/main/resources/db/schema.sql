-- ============================================================
-- GNIMAH HOTEL MANAGEMENT SYSTEM - DATABASE SCHEMA
-- PostgreSQL 17+
-- ============================================================
...
DO $$ BEGIN
    CREATE TYPE role_type AS ENUM ('ADMIN', 'DIRECTEUR', 'AGENT');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE TYPE etat_chambre AS ENUM ('LIBRE', 'OCCUPEE', 'A_NETTOYER', 'EN_MAINTENANCE', 'HORS_SERVICE');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE TYPE type_chambre AS ENUM ('STANDARD', 'SUPERIEURE', 'DELUXE', 'SUITE', 'FAMILIALE');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE TYPE type_location AS ENUM ('PASSAGE', 'SEJOUR');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE TYPE statut_reservation AS ENUM ('EN_ATTENTE', 'CONFIRMEE', 'ARRIVEE', 'ANNULEE', 'NO_SHOW');
EXCEPTION WHEN duplicate_object THEN null; END $$;

DO $$ BEGIN
    CREATE TYPE mode_paiement AS ENUM ('ESPECES', 'MOBILE_MONEY', 'CARTE', 'VIREMENT');
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
DO $$ BEGIN
    CREATE TYPE type_piece AS ENUM ('CNI', 'PASSEPORT', 'SEJOUR', 'PERMIS', 'AUTRE');
EXCEPTION WHEN duplicate_object THEN null; END $$;
...
CREATE TABLE IF NOT EXISTS sejours (
    ...
    type_location type_location NOT NULL DEFAULT 'SEJOUR',
